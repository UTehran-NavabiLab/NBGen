...
from ..file.main import InputFile
from ..synthesis.main import Synthesis
from ..test.main import Test
from ..faultSim.main import FaultSim
...
class MainWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.windows = {
            "file": InputFile(self),
            "synth": Synthesis(self),
            "test": Test(self),
            "faultsim": FaultSim(self)
        }
    ...
    def handle_btn_press(self, caller, name):
        ...
        self.windows[name].place(x=250, y=0, width=550.0, height=600.0)
