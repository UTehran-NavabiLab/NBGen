...
SC_MODULE(AND3_X1){
    ...
    SC_CTOR(AND3_X1){
        ...
        SC_METHOD(eval);
        sensitive << in1[0] << in1[1] << A3;

    }

    void eval(void){
        if ((in1[0]->read() == SC_LOGIC_0) || (in1[1]->read() == SC_LOGIC_0)|| (A3->read() == SC_LOGIC_0)){
            out1->write(SC_LOGIC_0);
        } else {
            out1->write(SC_LOGIC_1);
        }
...
SC_MODULE(AND4_X1){
    ...
    SC_CTOR(AND4_X1){
        ...
        SC_METHOD(eval);
        sensitive << in1[0] << in1[1] << A3 << A4;

    }

    void eval(void){
        if ((in1[0]->read() == SC_LOGIC_0) || (in1[1]->read() == SC_LOGIC_0) || (A3->read() == SC_LOGIC_0) || (A4->read() == SC_LOGIC_0)){
            out1->write(SC_LOGIC_0);
        } else {
            out1->write(SC_LOGIC_1);
        }
...
SC_MODULE(NAND3_X1){
    ...
    void eval(void){
        if ((in1[0]->read() == SC_LOGIC_1) && (in1[1]->read() == SC_LOGIC_1) && (A3->read() == SC_LOGIC_1)){
            out1->write(SC_LOGIC_0);
        } else {
            out1->write(SC_LOGIC_1);
        }
...
SC_MODULE(NAND4_X1){
    ...
    void eval(void){
        if ((in1[0]->read() == SC_LOGIC_1) && (in1[1]->read() == SC_LOGIC_1) && (A3->read() == SC_LOGIC_1) && (A4->read() == SC_LOGIC_0)){
            out1->write(SC_LOGIC_0);
        } else {
            out1->write(SC_LOGIC_1);
        }
...
SC_MODULE(NOR4_X1){
    ...
    void eval(void){
        if ((in1[0]->read() == SC_LOGIC_0) && (in1[1]->read() == SC_LOGIC_0) && (A3->read() == SC_LOGIC_0) && (A4->read() == SC_LOGIC_1)){
            out1->write(SC_LOGIC_1);
        } else {
            out1->write(SC_LOGIC_0);
        }
