...
class json2systemc_pwr(json2systemc):
    def __init__(self, json_file, technology_parameter, config_json,  gate_signal_file="") -> None:
        json2systemc.__init__(self, json_file, technology_parameter,config_json, gate_signal_file)
