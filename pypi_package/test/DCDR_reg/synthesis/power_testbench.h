...
SC_MODULE( testbench ) {
    ...
    void registration_and_tracing(void){
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$182);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$183);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$184);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$185);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$186);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$187);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$188);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$189);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$190);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$191);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$192);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$193);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$194);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$195);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$196);
        power_module->register_gate(cut->$abc$181$auto$blifparse.cc:386:parse_blif$197);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$105);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$106);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$107);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$108);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$109);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$110);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$111);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$112);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$113);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$114);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$115);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$116);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$117);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$118);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$119);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$120);
        power_module->register_gate(cut->$auto$ff.cc:266:slice$121);
