...
SC_MODULE( register ) {
    ...
    sc_signal_pw<sc_logic> CK = sc_signal_pw<sc_logic>("CK");
    sc_signal_pw<sc_logic> R = sc_signal_pw<sc_logic>("R");
    sc_signal_pw<sc_logic> cnt_0 = sc_signal_pw<sc_logic>("cnt_0");
    sc_signal_pw<sc_logic> cnt_1 = sc_signal_pw<sc_logic>("cnt_1");
    sc_signal_pw<sc_logic> cnt_2 = sc_signal_pw<sc_logic>("cnt_2");
    sc_signal_pw<sc_logic> cnt_3 = sc_signal_pw<sc_logic>("cnt_3");
