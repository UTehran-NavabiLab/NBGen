...
#ifndef __CONVERGENCE_ACCUMULATOR_PLATE_6_H__
#define __CONVERGENCE_ACCUMULATOR_PLATE_6_H__
using namespace sc_core;

SC_MODULE( convergence_accumulator_plate_6 ) {

    sc_in<sc_logic> clk;
    sc_in<sc_logic> rst;
    sc_in<sc_logic> run;
    sc_in<sc_logic> din[192];
    ...
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> S1[192];
    ...
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> c_add_ctrl_170_0_ = sc_signal<sc_logic, sc_core::SC_MANY_WRITERS>("c_add_ctrl_170_0_");
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> c_add_ctrl_170_1_ = sc_signal<sc_logic, sc_core::SC_MANY_WRITERS>("c_add_ctrl_170_1_");
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> c_add_ctrl_170_2_ = sc_signal<sc_logic, sc_core::SC_MANY_WRITERS>("c_add_ctrl_170_2_");
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> c_add_ctrl_170_3_ = sc_signal<sc_logic, sc_core::SC_MANY_WRITERS>("c_add_ctrl_170_3_");
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> c_add_ctrl_171 = sc_signal<sc_logic, sc_core::SC_MANY_WRITERS>("c_add_ctrl_171");
...
SC_CTOR( convergence_accumulator_plate_6 ) {
    ...
    BUF_X1_218 = new BUF_X1("BUF_X1_218");
        BUF_X1_218->A(S2[30]);
        BUF_X1_218->Z(dout[30]);

    BUF_X1_219 = new BUF_X1("BUF_X1_219");
        BUF_X1_219->A(S2[31]);
        BUF_X1_219->Z(dout[31]);
    ...
    c_add_ctrl = new cap_controller("c_add_ctrl");
        ...
        c_add_ctrl->count[1](sc_logic_1_signal);
        c_add_ctrl->count[2](sc_logic_1_signal);
        c_add_ctrl->count[3](sc_logic_0_signal);
        c_add_ctrl->in_reg(c_add_ctrl_171);
        c_add_ctrl->out_reg(S3);
        c_add_ctrl->rst(S4);
        c_add_ctrl->run(S5);
        c_add_ctrl->sel[0](c_add_ctrl_170_0_);
        c_add_ctrl->sel[1](c_add_ctrl_170_1_);
        c_add_ctrl->sel[2](c_add_ctrl_170_2_);
        c_add_ctrl->sel[3](c_add_ctrl_170_3_);
    ...
    mux = new mux_cascading("mux");
        ...
        mux->sel[0](c_add_ctrl_170_0_);
        mux->sel[1](c_add_ctrl_170_1_);
        mux->sel[2](c_add_ctrl_170_2_);
        mux->sel[3](c_add_ctrl_170_3_);
...
#endif /* __CONVERGENCE_ACCUMULATOR_PLATE_6_H__ */
