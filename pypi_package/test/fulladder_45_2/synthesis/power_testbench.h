...
SC_MODULE( testbench ) {
    ...
    std::array<sc_signal_pw<sc_logic>*, 16> signal_arr;
    ...
    void power_on_cycle(void){
        power_module->update_signal<sc_dt::sc_logic, 16>(signal_arr);
        ...
        float dynamic_power = pwr_INV_X1_1[0] + pwr_INV_X1_2[0] + pwr_INV_X1_3[0] + pwr_NAND2_X1_1[0] + pwr_NAND2_X1_2[0] + pwr_NAND2_X1_3[0] + pwr_NAND3_X1_1[0] + pwr_OAI21_X1_1[0] + pwr_OAI21_X1_2[0] + pwr_AND2_X1_1[0] + pwr_NOR2_X1_1[0] + pwr_BUF_X1_1[0] + pwr_BUF_X1_2[0] ;
        float net_switching_power = pwr_INV_X1_1[1] + pwr_INV_X1_2[1] + pwr_INV_X1_3[1] + pwr_NAND2_X1_1[1] + pwr_NAND2_X1_2[1] + pwr_NAND2_X1_3[1] + pwr_NAND3_X1_1[1] + pwr_OAI21_X1_1[1] + pwr_OAI21_X1_2[1] + pwr_AND2_X1_1[1] + pwr_NOR2_X1_1[1] + pwr_BUF_X1_1[1] + pwr_BUF_X1_2[1] ;
