...
SC_MODULE( cmp ) {
    ...
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> S100[16];
    sc_signal<sc_logic, sc_core::SC_MANY_WRITERS> S101[16];
...
SC_CTOR( cmp ) {
    ...
    AOI22_X1_1 = new AOI22_X1("AOI22_X1_1");
        AOI22_X1_1->A1(S62);
        AOI22_X1_1->A2(S100[9]);
        AOI22_X1_1->B1(S63);
        AOI22_X1_1->B2(S101[8]);
        AOI22_X1_1->ZN(S64);
    ...
    AOI22_X1_2 = new AOI22_X1("AOI22_X1_2");
        AOI22_X1_2->A1(S66);
        AOI22_X1_2->A2(S100[8]);
        AOI22_X1_2->B1(S65);
        AOI22_X1_2->B2(S101[9]);
        AOI22_X1_2->ZN(S67);
    ...
    AOI22_X1_3 = new AOI22_X1("AOI22_X1_3");
        AOI22_X1_3->A1(S75);
        AOI22_X1_3->A2(S100[4]);
        AOI22_X1_3->B1(S74);
        AOI22_X1_3->B2(S101[5]);
        AOI22_X1_3->ZN(S76);
    ...
    AOI22_X1_4 = new AOI22_X1("AOI22_X1_4");
        AOI22_X1_4->A1(S77);
        AOI22_X1_4->A2(S100[5]);
        AOI22_X1_4->B1(S78);
        AOI22_X1_4->B2(S101[4]);
        AOI22_X1_4->ZN(S79);
    ...
    OAI22_X1_1 = new OAI22_X1("OAI22_X1_1");
        OAI22_X1_1->A1(S101[0]);
        OAI22_X1_1->A2(S84);
        OAI22_X1_1->B1(S85);
        OAI22_X1_1->B2(S101[1]);
        OAI22_X1_1->ZN(S86);
    ...
    AOI22_X1_5 = new AOI22_X1("AOI22_X1_5");
        AOI22_X1_5->A1(S100[0]);
        AOI22_X1_5->A2(S89);
        AOI22_X1_5->B1(S87);
        AOI22_X1_5->B2(S100[1]);
        AOI22_X1_5->ZN(S1);
