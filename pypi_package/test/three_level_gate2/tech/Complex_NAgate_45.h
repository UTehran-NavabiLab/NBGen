...
SC_MODULE(NAND4_X1){
    ...
    void eval(void){
        if ((A1->read() == SC_LOGIC_1) && (A2->read() == SC_LOGIC_1) && (A3->read() == SC_LOGIC_1) && (A4->read() == SC_LOGIC_0)){
            ZN->write(SC_LOGIC_0);
        } else {
            ZN->write(SC_LOGIC_1);
        }
...
SC_MODULE(NOR4_X1){
    ...
    void eval(void){
        if ((A1->read() == SC_LOGIC_0) && (A2->read() == SC_LOGIC_0) && (A3->read() == SC_LOGIC_0) && (A4->read() == SC_LOGIC_1)){
            ZN->write(SC_LOGIC_1);
        } else {
            ZN->write(SC_LOGIC_0);
        }
