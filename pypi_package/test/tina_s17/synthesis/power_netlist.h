...
SC_MODULE( sequence ) {
    ...
    sc_signal_pw<sc_logic> ns_0 = sc_signal_pw<sc_logic>("ns_0");
    sc_signal_pw<sc_logic> ns_1 = sc_signal_pw<sc_logic>("ns_1");
    sc_signal_pw<sc_logic> ps_0 = sc_signal_pw<sc_logic>("ps_0");
    sc_signal_pw<sc_logic> ps_1 = sc_signal_pw<sc_logic>("ps_1");
